async function renderAdvOverview(symbol, interval) {
    ...
    const volumeSeries = chart.addHistogramSeries({ color: '#26a69a', title: 'Volume', priceFormat: { type: 'volume' }, priceScaleId: '', scaleMargins: { top: 0.65, bottom: 0 }, lastValueVisible: false, priceLineVisible: false });
