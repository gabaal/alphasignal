...
const POWER_TRIO_ASSETS = [
    ...
    'INJ-USD','NEAR-USD','SEI-USD','DOT-USD','ATOM-USD','TRX-USD',
    'DOGE-USD','WIF-USD','BONK-USD','AAVE-USD','MKR-USD','LDO-USD',
    'CRV-USD','FET-USD','RENDER-USD','OCEAN-USD','OP-USD','STRK-USD',
];
