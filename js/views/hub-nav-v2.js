window.renderHubTabs = function(activeTab, tabs) {
    if (!tabs) return '';
    return `
...
// Global exports for cross-module visibility
window.macroHubTabs = macroHubTabs;
window.alphaHubTabs = alphaHubTabs;
window.institutionalHubTabs = institutionalHubTabs;
window.analyticsHubTabs = analyticsHubTabs;
window.auditHubTabs = auditHubTabs;
window.alertsHubTabs = alertsHubTabs;

console.log("[HubNav] Institutional Tabs Count:", institutionalHubTabs.length, institutionalHubTabs.map(t => t.label));
