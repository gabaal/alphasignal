                ...
                <div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:1.2rem;">
                    <h3 style="margin:0;font-size:0.85rem;color:var(--accent);letter-spacing:1px;"><span class="material-symbols-outlined" style="font-size:1rem;vertical-align:middle;margin-right:6px;">radar</span>SIGNAL CONFIDENCE RADAR
                        <div id="radar-custom-select" style="position:relative;display:inline-block;margin-left:10px;font-size:0.7rem;font-weight:normal;vertical-align:middle;">
                            <div id="radar-select-btn" style="background:var(--bg-input);border:1px solid rgba(0,242,255,0.25);color:#e2e8f0;padding:3px 26px 3px 10px;border-radius:4px;cursor:pointer;font-family:'JetBrains Mono',monospace;min-width:54px;user-select:none;position:relative;">
                            ...
                            <div id="radar-select-list" style="display:none;position:absolute;top:calc(100% + 4px);left:0;background:var(--bg-input);border:1px solid rgba(0,242,255,0.25);border-radius:6px;z-index:9999;min-width:80px;max-height:220px;overflow-y:auto;scrollbar-width:thin;scrollbar-color:rgba(0,242,255,0.3) transparent;box-shadow:0 8px 24px rgba(0,0,0,0.7);">
                                ${_radarOpts}
                            </div>
                        </div>
                </div>
