function switchView(view, pushState = true) {
    ...
    if (window._ppAutoRefresh) { clearInterval(window._ppAutoRefresh); window._ppAutoRefresh = null; }
    ...
    const isFreeView = isPublicView || view === 'command-center' || view === 'free-tier' || view === 'my-terminal' || view === 'price-alerts' || view === 'market-brief' || view === 'signal-leaderboard' || view === 'trade-setup' || view === 'trade-plan';
