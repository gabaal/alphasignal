...
const viewMap = {
    ...
    'risk-hub': () => switchView('institutional-hub'),
    ...
    // ---- Hub-level overview docs (docs-c.js) ----
    'docs-hub-macro': () => typeof renderHubOverviewMacro !== 'undefined' ? renderHubOverviewMacro() : renderHelp(),
    'docs-hub-alpha': () => typeof renderHubOverviewAlpha !== 'undefined' ? renderHubOverviewAlpha() : renderHelp(),
    'docs-hub-portfolio': () => typeof renderHubOverviewInstitutional !== 'undefined' ? renderHubOverviewInstitutional() : renderHelp(),
    'docs-hub-analytics': () => typeof renderHubOverviewAnalytics !== 'undefined' ? renderHubOverviewAnalytics() : renderHelp(),
    'docs-hub-audit': () => typeof renderHubOverviewAudit !== 'undefined' ? renderHubOverviewAudit() : renderHelp(),
    'docs-hub-alerts': () => typeof renderHubOverviewAlerts !== 'undefined' ? renderHubOverviewAlerts() : renderHelp(),
    'docs-hub-my-terminal': () => typeof renderHubOverviewMyTerminal !== 'undefined' ? renderHubOverviewMyTerminal() : renderHelp(),
    'docs-hub-exchange': () => typeof renderHubOverviewExchangeKeys !== 'undefined' ? renderHubOverviewExchangeKeys() : renderHelp(),
