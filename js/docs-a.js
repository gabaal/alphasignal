    ...
    const hubs = [
        ...
        { id: 'quant-academy', name: 'Quant Academy (SEO)', icon: 'school', color: '#f472b6', view: 'help',
          docs: [
            ...
            { name: 'Candlestick Patterns', desc: 'Interpreting bullish engulfing, dojis, and hammers', href: '/academy/candlestick-patterns', icon: 'candlestick_chart' },
            ...
            { name: 'Divergence Trading', desc: 'Spot bullish and bearish divergences', href: '/academy/divergence-trading-strategies', icon: 'call_split' },
            { name: 'Elliott Wave Theory', desc: 'Identify motive and corrective waves', href: '/academy/elliott-wave-theory', icon: 'waves' },
            ...
            { name: 'Harmonic Patterns', desc: 'Utilize advanced geometry for reversal zones', href: '/academy/harmonic-patterns-trading', icon: 'polyline' },
            { name: 'Ichimoku Cloud', desc: 'One Glance Equilibrium Chart', href: '/academy/ichimoku-cloud-strategy', icon: 'cloud' },
            ...
            { name: 'Order Blocks', desc: 'Identifying Institutional Order Blocks', href: '/academy/order-blocks-institutional', icon: 'view_in_ar' },
            ...
            { name: 'Pairs Trading', desc: 'Pairs Trading and Statistical Arbitrage', href: '/academy/pairs-trading-crypto-arbitrage', icon: 'balance' },
            { name: 'Position Sizing', desc: 'Leverage Strategies and Survival', href: '/academy/position-sizing-and-leverage', icon: 'scale' },
            { name: 'Price Action Trading', desc: 'Naked Price Action Trading', href: '/academy/price-action-trading-naked', icon: 'show_chart' },
            ...
            { name: 'Smart Money Concepts', desc: 'Understand FVG, Inducement, and Liquidity Grabs', href: '/academy/smart-money-concepts-smc', icon: 'lightbulb' },
            ...
            { name: 'Trendlines and Channels', desc: 'Drawing ascending and descending channels', href: '/academy/trendlines-and-channels', icon: 'show_chart' },
            ...
            { name: 'Wyckoff Method', desc: 'The Wyckoff Method Accumulation and Distribution', href: '/academy/wyckoff-method-accumulation-distribution', icon: 'account_balance' },
            ...
            <div style="border:1px solid ${alphaColor(0.07)};border-radius:14px;overflow:hidden">
                <div style="padding:1rem 1.4rem;background:${alphaColor(0.03)};border-bottom:1px solid ${alphaColor(0.06)};display:flex;align-items:center;justify-content:space-between;flex-wrap:wrap;gap:8px">
                    <div style="display:flex;align-items:center;gap:10px">
                        <span class="material-symbols-outlined" style="color:${hub.color};font-size:1.4rem">${hub.icon}</span>
                        <span style="font-size:0.95rem;font-weight:900;letter-spacing:1px;color:${hub.color}">${hub.name}</span>
                        <span style="font-size:0.65rem;color:var(--text-dim);font-weight:700;background:${alphaColor(0.05)};padding:2px 8px;border-radius:100px;border:1px solid ${alphaColor(0.08)}">${hub.docs.length} VIEW${hub.docs.length > 1 ? 'S' : ''}</span>
                    </div>
                    <button onclick="switchView('${hub.view}')" style="background:${alphaColor(0.05)};border:1px solid ${alphaColor(0.1)};color:var(--text-dim);padding:4px 12px;border-radius:100px;font-size:0.7rem;font-weight:700;letter-spacing:1px;cursor:pointer;display:flex;align-items:center;gap:5px;transition:all 0.2s" onmouseover="this.style.borderColor='${hub.color}';this.style.color='${hub.color}'" onmouseout="this.style.borderColor=alphaColor(0.1);this.style.color='var(--text-dim)'">
                        <span class="material-symbols-outlined" style="font-size:15px">open_in_new</span> OPEN HUB
                    </button>
                </div>
