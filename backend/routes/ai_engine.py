...
class AIEngineRoutesMixin:
    ...
    def handle_explain_chart(self, post_data):
        ...
        personas = {
            ...
            'options': "You are an Institutional Volatility & Derivatives Desk Trader. Synthesize the Put/Call ratio, Max Pain, IV Smile skew, and heavy Open Interest strikes for the given asset ticker. Explain what structural bets whales are making in plain English, and provide a clear thesis on what this means for near-term spot price gravity for this specific coin.",
            'tape': "You are an Institutional Order Flow Analyst. Analyze the raw institutional tape (list of recent trades with side and size) and the current order book imbalance. Explain in plain English whether there is aggressive absorption, distributive selling, or iceberg order activity, and what it implies for the next 5-15 minutes of price action."
        }
