...
# remains open. The 4-space indent below correctly attaches this method to it.
    ...
    def generate_alpha_alerts(self, data, current_regime=None):
        ...
        # Get all enabled users once at the start of generate_alpha_alerts
        try:
            ...
            print(f"Error reading user settings: {ue_err}")
            enabled_users = []
        ...
        for ticker in all_tickers:
            ...
            try:
                ...
                if is_active_z or is_warming_z:
                    ...
                    if _direction == 'LONG':
                        ...
                        try:
                            ...
                            ML_LONG_HIGHVOL_ZSCORE    = 1.75    # require z >= 1.75 on noisy tickers
                ...
                if signal_type:
                    ...
                    # Add fully qualified signal to candidate list
                    candidates.append({
                        'ticker': ticker,
                        'pred_return': pred_return,
                        ...
                        '_cat': _cat,
                        '_mtf_score': _mtf_score,
                        '_mtf_detail': _mtf_detail
                    })

                    # Record Prediction Metadata (once, globally per predicted ticker)
